...
def plotPriceHistory(investment):
    ...
    for entry in history:
        dateList.append(
            "{}-{}-{}".format(entry.date.year, entry.date.month, entry.date.day)
        )
    ...
    path = os.path.join(
        "/Users/mullsy/workspace/Buffetiser_Unchained/"
        "buffetiser_main/static/buffetiser_main/img/",
