...
class PublicUserApiTests(TestCase):
    ...
    def test_user_with_email_exists_error(self):
        """Test error returned if the user email already exists."""
    ...
    def test_create_token_no_password(self):
        """Test returns error if no password is provided."""
...
class PrivateUserApitTests(TestCase):
    ...
    def test_retrieve_profile_success(self):
        """Test that we can retrieve the details of an authorised user."""
    ...
    def test_post_me_not_allowed(self):
        """Test that POST is not allowed to the me endpoint."""
    ...
    def test_update_user_profile(self):
        """Test updating the profile for an authorised user."""
